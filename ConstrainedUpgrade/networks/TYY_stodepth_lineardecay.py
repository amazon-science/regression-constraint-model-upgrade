...
class StoDepth_BasicBlock(nn.Module):
    ...
    def __init__(self, prob, multFlag, inplanes, planes, stride=1, downsample=None, force_sampling=False):
...
class ResNet_StoDepth_lineardecay(nn.Module):
    ...
    def __init__(self, block, prob_0_L, multFlag, layers, num_classes=1000, zero_init_residual=False, force_sampling=False):
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        layers = []
        layers.append(block(self.prob_now, self.multFlag, self.inplanes, planes, stride, downsample, self.force_sampling))
